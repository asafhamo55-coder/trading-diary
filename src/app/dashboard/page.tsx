...
import { getDemoStats, DEMO_TRADES, getDemoMonthlyPnL } from "@/lib/demo-data";
...
export default function DashboardPage() {
  ...
  const monthlyPnL = getDemoMonthlyPnL();
  const recentTrades = [...DEMO_TRADES]
    .filter((t) => t.isCompleted)
    .sort((a, b) => b.tradeDate.localeCompare(a.tradeDate))
    .slice(0, 5);

  const totalReturn = stats.totalPnL / 178600;
